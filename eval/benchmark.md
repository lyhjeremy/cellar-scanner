...
|---|---|---|---|---|---|---|
| base | 300 | 8.7% | 14.3% | 0.021 | 4.287 | 0 |
| lora | 300 | 27.7% | 27.7% | 0.253 | 10.577 | 0 |
| claude_teacher | 200 | 23.0% | 30.5% | 0.119 | 69.617 | Max subscription (no per-call API cost) |

## Top confusions (LoRA model, true -> predicted)

- Cabernet Sauvignon -> Cabernet Franc: 10 times
- Pinot Gris -> Viognier: 8 times
- Syrah -> Cabernet Franc: 6 times
- Nebbiolo -> Sangiovese: 6 times
- Red Blend -> Sangiovese: 5 times
- Chardonnay -> Viognier: 5 times
- Portuguese White -> Viognier: 5 times
- Grüner Veltliner -> Viognier: 5 times
- Riesling -> Viognier: 5 times
- Sauvignon Blanc -> Viognier: 5 times
